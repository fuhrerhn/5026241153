...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-8">
                <p class="open-sans-judul"><b>Danantara Indonesia</b> is an investment management agency that oversees, optimizes, and grows
                    Indonesia's
                    strategic assets, in line with the country's long-term agenda for economic transformation.
                </p>
            </div>
            <div class="col-4">
                <div class="row">
